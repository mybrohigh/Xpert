...
Система мониторинга трафика полностью интегрирована с Marzban Panel! Теперь кнопки **"Сбросить трафик"** и **"Лимит трафика"** работают как для обычных пользователей Marzban, так и для внешних серверов через Xpert.
