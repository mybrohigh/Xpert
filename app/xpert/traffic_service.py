...
Мониторинг использования внешних VPN серверов через Xpert Panel
"""
    ...
    def get_global_stats(self, days: int = 30) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "total_gb_used": round(result[2] / (1024**3), 3) if result[2] else 0,
    ...
    def get_server_stats(self, server: str, port: int, days: int = 30) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "total_gb_used": round(result[1] / (1024**3), 3) if result[1] else 0,
                "total_connections": result[2],
                "avg_gb_per_connection": round(result[3] / (1024**3), 3) if result[3] else 0,
                "daily_stats": [
                    {
                        "date": row[0],
